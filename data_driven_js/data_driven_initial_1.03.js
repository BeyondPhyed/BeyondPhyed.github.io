...
function consoleData(_x1 = vy, _x2 = vy2) {
	console.log(round(t, 2) + ',' + round(_x1, 2) + ',' + round(_x2, 2));
}

function setupCSV(_x1 = vy, _x2 = vy2) {
	// set current time
	timeInput[0] = month();
	timeInput[1] = day();
	timeInput[2] = hour();
	...
	writer.print(round(t,2) + ',' + round(_x1,2) + ',' + round(_x2,2));
}

function saveData(_x1 = vy, _x2 = vy2) {
	writer.print(round(t,2) + ',' + round(_x1,2) + ',' + round(_x2,2));
}
